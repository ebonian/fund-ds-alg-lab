...
public class BSTRecursive {
	...
	public int numNodesLessThan(BSTNode n,int v) {
	    ...
	    if (n.data < v) {
	        numNodes++;
	        numNodes += numNodesLessThan(n.left, v);
	        numNodes += numNodesLessThan(n.right, v);
	    } else {
	        numNodes += numNodesLessThan(n.left, v);
	    }
	...
	public int numLeavesLessThan(BSTNode n, int v) {
	    ...
	    int leftLeaves = numLeavesLessThan(n.left, v);
	    int rightLeaves = numLeavesLessThan(n.right, v);
